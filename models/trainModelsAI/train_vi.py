"""
models/summarization/train_vi.py
-------------------------------
Script chuyên dụng để fine-tune ViT5 cho tiếng Việt.
...
from models.summarization.config import VI_TRAIN, TRAIN_PATH, VAL_PATH
from models.summarization.dataset import JsonlSummarizeDataset

def train():
    cfg = VI_TRAIN
    print(f"Starting training VI with model: {cfg['model_name']}")
